...
///   model, corrupt bytes) yields `[]`; the image stays editable with a
///   manual-review notice instead of being discarded.
...
class MlKitBarcodeDetector implements CodeRegionDetector {
  ...
  Future<List<DetectionRegion>> detect(Uint8ListImageInput input) async {
    ...
    try {
      final prepared = await compute(_prepareNv21ForBarcode, <String, Object>{
...
Map<String, Object>? _prepareNv21ForBarcode(Map<String, Object> payload) {
